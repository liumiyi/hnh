...
extern uint8_t can1_0x1FF_TxData[8];
extern uint8_t can2_0x2FF_TxData[8];
...
extern Motor_Info motor_info4;//pitch电机的结构体

extern Motor_Info motor_info5;//yaw电机的结构体
...
void CAN_Transmit_4(int16_t v);//pitch电机
void CAN_Transmit_5(int16_t v);//yaw电机
